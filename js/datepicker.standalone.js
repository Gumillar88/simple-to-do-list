...
(function (global, factory) {
	...
	//for value date (return this.clone().locale('en').format('ddd MMM DD YYYY HH:mm:ss [GMT]ZZ');) by : gugum
    function toString () {
        return this.clone().locale('en').format('dddd, DD - MMMM - YYYY');
    }
